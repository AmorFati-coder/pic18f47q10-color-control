...
# 10 "/Applications/microchip/xc8/v2.36/pic/include/c99/stdlib.h" 3
...
void RGBLed_SetColor(uint32_t *AdiodeArray) {
    ...
    if(tempData & 1) {
        do { LATAbits.LATA7 = 1; } while(0); _delay(10); do { LATAbits.LATA7 = 0; } while(0);;
    } else {
        do { LATAbits.LATA7 = 1; } while(0); _delay(5); do { LATAbits.LATA7 = 0; } while(0); _delay(4);;
    }
    tempData >>= 1;
    if(tempData & 1) {
        do { LATAbits.LATA7 = 1; } while(0); _delay(10); do { LATAbits.LATA7 = 0; } while(0);;
